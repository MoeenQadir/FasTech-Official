                        ...
                        <div className="content-column col-lg-8 col-md-12 col-sm-12">
                            <div className="inner-column">
                                ...
                                <ul className="post-meta">
                                    <li><span className="icon flaticon-big-envelope"></span> <Link href="/">Merix@gmail.com</Link></li>
                                    <li><span className="icon flaticon-phone-call"></span> <Link href="/">999 - 999 - 9999</Link></li>
                                    <li><span className="icon fa fa-whatsapp"></span> <Link href="/">000 - 000 - 0000</Link></li>
                                </ul>
                                <div className="text">
